...
def merge_ranges(meeting_list):
    ...
    Args:
      meeting_list: a list of multiple meeting time ranges
    ...
    >> merge_ranges(meeting_list1)
    [(0, 1), (3, 8), (9, 12)]
    
    To test above function for end_time with a big number
    For example, given:
    ...
    >>> meeting_list2=[Meeting(0, 1),
              Meeting(3, 15),
              Meeting(4, 8),
              Meeting(10, 12),
              Meeting(9, 10)]

    >>> merge_ranges(meeting_list2)
    [(0, 1), (3, 15)]
    """    
